$(document).ready(function() {
  ...
  $.template('detail', '<div class="image"><img alt="${name}" src="/assets/${slug}.jpeg"></div><h3>${name}</h3><p><strong>Price:</strong> ${price}</p><p><a href="${url}" target="_blank">View on Homeaway</a></p><p class="synopsis"><strong>Description:</strong> ${description}</p>');
